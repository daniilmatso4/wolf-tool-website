...
export const ACHIEVEMENTS = [
  { id: 'first_call', name: 'First Dial', description: 'Make your first phone call', icon: '☎', category: 'calls' },
  { id: 'calls_10', name: 'Phone Warrior', description: 'Make 10 phone calls', icon: '📞', category: 'calls' },
  { id: 'calls_50', name: 'Dialing Machine', description: 'Make 50 phone calls', icon: '🔥', category: 'calls' },
  { id: 'calls_100', name: 'The Closer', description: 'Make 100 phone calls', icon: '🏆', category: 'calls' },
  { id: 'first_email', name: 'First Outreach', description: 'Send your first email', icon: '✉', category: 'emails' },
  { id: 'emails_25', name: 'Inbox Slayer', description: 'Send 25 emails', icon: '📧', category: 'emails' },
  { id: 'emails_100', name: 'Email Mogul', description: 'Send 100 emails', icon: '📬', category: 'emails' },
  { id: 'first_deal', name: 'First Blood', description: 'Close your first deal', icon: '💰', category: 'deals' },
  { id: 'deals_5', name: 'Deal Maker', description: 'Close 5 deals', icon: '💵', category: 'deals' },
  { id: 'deals_25', name: 'Money Machine', description: 'Close 25 deals', icon: '💸', category: 'deals' },
  { id: 'streak_3', name: 'On Fire', description: '3 day activity streak', icon: '🔥', category: 'streak' },
  { id: 'streak_7', name: 'Week Warrior', description: '7 day activity streak', icon: '⚡', category: 'streak' },
  { id: 'streak_30', name: 'Unstoppable', description: '30 day activity streak', icon: '💪', category: 'streak' },
  { id: 'first_meeting', name: 'Face Time', description: 'Log your first meeting', icon: '🤝', category: 'meetings' },
  { id: 'meetings_10', name: 'Networking Pro', description: 'Log 10 meetings', icon: '🌐', category: 'meetings' },
  { id: 'leads_10', name: 'Prospector', description: 'Save 10 leads', icon: '🔍', category: 'leads' },
  { id: 'leads_50', name: 'Lead Hunter', description: 'Save 50 leads', icon: '🎯', category: 'leads' },
] as const;
